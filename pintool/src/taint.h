...
#define TAINT_NTQSI_PROCESSINFO      0
#define TAINT_NTQSI_MODULEINFO       0
#define TAINT_NTQSI_FIRMWAREINFO     0
#define TAINT_NTQSI_KERNELINFO       0
#define TAINT_NTQUERYATTRIBUTESFILE  0
#define TAINT_NTFINDWINDOW           0
// Function calls
#define TAINT_ISDEBUGGERPRESENT      1
